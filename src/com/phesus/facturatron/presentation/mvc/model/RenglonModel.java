 ...
 * @author saul
 */
public class RenglonModel extends Model implements Serializable {
    private Integer id;
    ...
    public static List createBeanCollection(){
        ...
        ArrayList<RenglonModel> rb = new ArrayList<RenglonModel>();
        /*
        RenglonModel renglon = new RenglonModel();
