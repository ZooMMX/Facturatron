...
/**
 * <p>Clase Java para stamped complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="stamped">
 *   &lt;complexContent>
...
@XmlType(name = "stamped", propOrder = {
    "xml",
    "username",
    "password"
})
public class Stamped {
    ...
    @XmlElementRef(name = "xml", namespace = "http://facturacion.finkok.com/stamp", type = JAXBElement.class, required = false)
